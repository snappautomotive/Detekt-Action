...
ARG REVIEWDOG_VERSION="0.20.2-snappautomotive"
...
RUN wget -O - -q https://raw.githubusercontent.com/snappautomotive/reviewdog/v${REVIEWDOG_VERSION}/install.sh | sh -s -- -b /usr/local/bin/
